...
const FeaturesSection = () => {
  ...
  const features = [
    // --- New Chrome Bot features ---
    {
      ...
      description:
        "Instantly summarize YouTube videos into key bullet points directly from the video page.",
    },
    {
      icon: <Brain />,
      title: "Auto Detect Article or Video",
      description:
        "Automatically detects whether you’re on an article or a video and summarizes accordingly.",
    },
    {
      icon: <Volume2 />,
      title: "Voice Summary",
      description:
        "Listen to your summaries in a natural voice for hands-free convenience.",
    },
    {
      icon: <Languages />,
      title: "Multi-Language Summaries",
      description:
        "Supports multiple global languages for better accessibility.",
    },
    {
      icon: <Cloud />,
      title: "Cloud Save",
      description:
        "Securely save your summaries in the cloud and access them anytime.",
    },
    ...
    // --- Original features ---
    {
      ...
      description:
        "Generate summaries in seconds using advanced AI technology.",
    },
    {
      icon: <FileText />,
    ...
    },
    {
      ...
      title: "Any Website",
      description:
        "Works on any webpage - articles, blogs, research papers, and more.",
    },
    {
      icon: <Chrome />,
    ...
    },
    {
      ...
      description:
        "AI understands context and extracts the most relevant information.",
    },
    {
      icon: <Copy />,
      title: "Easy Export",
    ...
    },
    {
      ...
      title: "Voice Control",
      description:
        "Easily control the summarization process with your voice.",
    },
    {
      icon: <Share />,
    ...
    },
    {
      ...
      description:
        "Manage your summary history with simple save and delete controls.",
    },
    {
      icon: <Volume2 />,
    ...
    },
    {
      ...
      description: "Download your summaries in PDF format with a single click.",
    },
    {
      icon: <Languages />,
      title: "Multi-Language Support",
      description:
        "Generate summaries in multiple (10+) languages with ease.",
    },
    {
      icon: <Wallpaper />,
      title: "Theme Customization",
      description:
        "Switch between light, dark, or colorful themes for better comfort.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Everything you need to transform information consumption and boost
              productivity.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg">
              Your journey from installation to productivity
            </p>
          </div>
